...
//    - added support for P1 Smart Meter (Energy)
//    - added support for Oregon UVN800 UV-meter
// V0.1.11 - 2016/02/10
...
eDomoticzAccessory.prototype = {
    ...
    getServices: function() {
        ...
        if (typeof this.swTypeVal !=='undefined' && this.swTypeVal){ // is a switch
          ...
          switch(true){
            case this.Type == "General" || this.Type == "YouLess Meter" || this.Type == "Current" || this.Type == "P1 Smart Meter" || this.Type == "UV":{
