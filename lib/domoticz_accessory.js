...
eDomoticzAccessory.prototype = {
	...
	getCharacteristic: function(service, name) {
		var characteristic = service.getCharacteristic(name);
		if (!characteristic)
		{
			...
			case this.Type == "Air Quality":
				{
					...
					this.getCharacteristic(airQualityService, Characteristic.AirParticulateDensity);
					this.getCharacteristic(airQualityService, Characteristic.AirParticulateDensity).on('get', this.getValue.bind(this));
