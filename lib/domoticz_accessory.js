...
eDomoticzAccessory.prototype = {
			...
			case this.Type == "P1 Smart Meter" || this.type="RFXMeter":
				{
					if ('undefined' !== typeof message.svalue1) {
						if (this.subType == "Gas") {
							...
							var RFXMeterDeviceCharacteristic = this.getService(eDomoticzServices.GasDeviceService).getCharacteristic(eDomoticzServices.GasConsumption);
	...
	getServices: function() {
		...
		} else // Accessory is a sensor
		{
			...
			case this.type=="RFXMeter" || this.Type == "P1 Smart Meter":
				{
					if (this.subType == "Gas" || this.subtype =="RFXMeter Counter") {
