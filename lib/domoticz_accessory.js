...
eDomoticzAccessory.prototype = {
    ...
    handleMQTTMessage: function(message, callback) {
      this.log(message);
      if ((this.Type=="P1 Smart Meter" && this.swTypeVal==1 && this.subType=="Gas")||(this.Type=="General" && this.swTypeVal==2 && this.subType=="Counter Incremental")||(this.name.indexOf("Occupied") > -1)||(this.Type=="General" && this.swTypeVal==1 && this.subType=="Visibility")||(this.Type=="General" && this.swTypeVal==0 && this.subType=="kWh")){
        ...
        switch(true){
	        case this.Type == "General" || this.Type == "YouLess Meter" || this.Type == "Current" || this.Type == "UV" || this.Type == "Usage" || this.Type == "Lux":{
				if (this.subType == "kWh" || this.subType == "YouLess counter" || this.subType == "Electric") {
					...
					callback(UsageDeviceCharacteristic, message.svalue1);
					break;
			...
			case this.Type == "Temp" || this.Type == "Temp + Humidity" || this.Type == "Temp + Humidity + Baro":{
	            ...
	            callback(temperatureSensorCharacteristic,message.svalue1);
	            if (this.Type == "Temp + Humidity" || this.Type == "Temp + Humidity + Baro") {
	                ...
	                callback(HumidityCharacteristic ,message.svalue1);
	                if (this.Type == "Temp + Humidity + Baro") {
						...
						callback(BarometerCharacteristic,message.svalue1);
	                }
	            }
	            break;
	        }
	        case this.Type == "P1 Smart Meter":{
                if (this.subType == "Gas"){
                  ...
                  callback(P1GasMeterDeviceCharacteristic,message.svalue1);
            ...
            default:{
              if (this.name.indexOf("Occupied") > -1) {
                        ...
                        var dswitchCharacteristic = this.getService(Service.Switch).getCharacteristic(Characteristic.On);
                        callback(dswitchCharacteristic,message.nvalue);
                        this.isSwitch = 1;
                        break;
                }
            }
    ...
    getServices: function() {
        ...
        if ((this.Type=="P1 Smart Meter" && this.swTypeVal==1 && this.subType=="Gas")||(this.Type=="General" && this.swTypeVal==2 && this.subType=="Counter Incremental")||(this.Type=="General" && this.swTypeVal==1 && this.subType=="Visibility")||(this.Type=="General" && this.swTypeVal==0 && this.subType=="kWh")){
          this.swTypeVal = false;
          this.isSwitch = false;
          //cludgey fix for a P1 SmartMeter Virtual Sensor being ID'd as a doorbell in Domoticz, and Incremental Counters being id'd as contact switches
