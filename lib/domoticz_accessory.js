...
eDomoticzAccessory.prototype = {
    ...
    setPoint: function (setpoint, callback, context) {
        ...
        if (this.subType == "SetPoint") {
            ...
            url = this.platform.apiBaseURL + "type=command&param=setused&idx=" + this.idx + "&setpoint=";
    ...
    setTempOverride: function (setuntil, callback, context) {
        ...
        Domoticz.deviceStatus(this, function (json) {
            ...
            sArray.map(function (s) {
                ...
                var therm = (this.Type == "Thermostat" && this.subType == "SetPoint" || this.Type == "Setpoint") ? true : false;
            ...
            case this.swTypeVal == Constants.DeviceTypeBlindsPlusStop:
                {
                    if (this.platform.config.legacyBlinds == 1) {
                        ...
                        var position = 0;
                        if (this.isPercentageBlind && message.nvalue > 1) {
                            if (message.ReversePosition == 'true') {
                                position = (100 - message.svalue1) * this.factor;
                            } else {
                                position = message.svalue1 * this.factor;
                            }
                        } else if ((this.swTypeVal == Constants.DeviceTypeBlindsVenetianUS || this.swTypeVal == Constants.DeviceTypeBlindsVenetianEU) && message.nvalue > 1) {
            ...
            case this.swTypeVal == Constants.DeviceTypeDimmer:
                {
                    ...
                    if (isFan) {
                        ...
                        if (this.subType == "RGBW" || this.subType == "RGBWW" || this.subType == "RGBWWZ" || this.subType == "RGBWZ" || this.subType == "RGB" ) {
            ...
            case this.swTypeVal == Constants.DeviceTypeBlindsPlusStop:
                {
                    ...
                    this.isPercentageBlind = (this.swTypeVal == Constants.DeviceTypeBlindsPercentage || this.swTypeVal == Constants.DeviceTypeBlindsPercentageInverted || this.swTypeVal == Constants.DeviceTypeBlindsPlusStop);
