...
eDomoticzAccessory.prototype = {
    ...
    setActiveIdentifier: function (identifier, callback, context) {
        ...
        if (this.hwType.toString() in tvInputAccessories) {
            Domoticz.updateDeviceStatus(tvInputAccessories[this.hwType.toString()], "switchlight", {
                "switchcmd": "Set Level",
                "level": identifier * 10
            }, function (success) {
                callback();
    ...
    getActiveIdentifier: function (callback) {
        ...
        if (this.hwType.toString() in tvInputAccessories) {
            Domoticz.deviceStatus(tvInputAccessories[this.hwType.toString()], function (json) {
                var value = 0;
                var sArray = Helper.sortByKey(json.result, "Name");
                sArray.map(function (s) {
                    value = s.Level / 10;
