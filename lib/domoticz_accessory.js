...
eDomoticzAccessory.prototype = {
    ...
    handleMQTTMessage: function(message, callback) {
      if (typeof this.swTypeVal !=='undefined'){ // is a switch
        switch (true) {
          ...
          case this.swTypeVal == 7:{ //dimmer (and RGBW)
            ...
            var characteristic = this.getService(Service.Lightbulb).getCharacteristic(Characteristic.On);
            callback(characteristic, (message.nvalue > 0));
