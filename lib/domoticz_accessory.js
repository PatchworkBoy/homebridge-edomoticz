        ...
        Domoticz.deviceStatus(this, function (json) {
            ...
            sArray.map(function (s) {
                try {
                    ...
                    this.platform.forceLog(this.name + '(WW Light): This device does not comply to Domoticz lighting standard for a WW light. Ignoring "Color".');
                    error = !0;
                }
            }.bind(this));

            callback(null, error == !1 ? value : null);
        }.bind(this));
    },
